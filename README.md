...
<aside>
💡 약 864만 건의 데이터를 다루고 다량의 차트를 구현했던 만큼 최적화와, 컴포넌트 분리에 공을 들였던 프로젝트입니다. 차트에 들어가는 데이터는 그 자체로도 양이 방대할 뿐더러, 분석 파트에서는 데이터 분석 로직까지 들어가 만들었던 서비스 중 응답시간이 가장 길었기 때문입니다.
